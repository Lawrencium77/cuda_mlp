...
$(ALLOCATOR_OUTPUT): $(ALLOCATOR_TEST_FILE)
	mkdir -p $(BUILD_DIR)
	$(NVCC) $(CFLAGS) $(NVCC_FLAGS) -o $(ALLOCATOR_OUTPUT) $(ALLOCATOR_TEST_FILE) $(ALLOCATOR_SRC_FILES)

$(MATRIX_OUTPUT): $(MATRIX_SRC_FILES) $(MATRIX_TEST_FILE)
	mkdir -p $(BUILD_DIR)
	$(NVCC) $(CFLAGS) $(NVCC_FLAGS) -o $(MATRIX_OUTPUT) $(MATRIX_TEST_FILE) $(MATRIX_SRC_FILES)

$(MODEL_OUTPUT): $(MODEL_SRC_FILES) $(MODEL_TEST_FILE) $(MATRIX_SRC_FILES)
	mkdir -p $(BUILD_DIR)
	$(NVCC) $(CFLAGS) $(NVCC_FLAGS) -o $(MODEL_OUTPUT) $(MODEL_TEST_FILE) $(MODEL_SRC_FILES) $(MATRIX_SRC_FILES)

$(TRAINING_OUTPUT): $(TRAINING_SRC_FILES)
	mkdir -p $(BUILD_DIR)
	$(NVCC) $(CFLAGS) $(NVCC_FLAGS) -o $(TRAINING_OUTPUT) $(TRAINING_SRC_FILES) $(MATRIX_SRC_FILES) $(DATA_SRC_FILES) $(MODEL_SRC_FILES)
